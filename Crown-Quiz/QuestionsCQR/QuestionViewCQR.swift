...
struct QuestionViewCQR: View {
    @Environment(\.dismiss) var dismiss
    @StateObject var vm: QuestionViewModelCQR
    ...
    var jrncfm = [352: "crfc"]
    init(type: GameTypeCQR) {
        _vm = StateObject(wrappedValue: QuestionViewModelCQR(typeOfGame: type))
    }
